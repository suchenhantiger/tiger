...
class ConfrimPopUp extends PureComponent {
    //构造函数
    constructor(props) {
        super(props);
    }
                ...
                <div className={ecardboxCls}>
                   ...
                   {this.props.children}
                     <div className={styles.pp_btns}>
                        <a className={styles.btn_pp_cancel} onClick={onCancel}>{canceltxt?canceltxt:'取消'}</a>
