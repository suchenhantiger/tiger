...
class CursorList extends BaseScroll{
    ...
    render(){
        //打印渲染日志，必写
        systemApi.log("CursorList render");
        return(
            <div className={this.getScrollStyle()}>
                {this.renderListBefore()}
                <IScrollView className={this.getListStyle()} isShowLoading={this.getIsShowLoading()} canUpFresh={true} upFresh={this.refreshDataFn} canDownFresh={true} downFresh={this.loadMoreFn} ref="scroll">
                    {this.renderUI()}
                </IScrollView>
            </div>
        );
