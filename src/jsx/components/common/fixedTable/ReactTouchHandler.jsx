...
import emptyFunction from './emptyFunction.jsx';
import requestAnimationFramePolyfill from './requestAnimationFramePolyfill.jsx';

var MOVE_AMPLITUDE = 1.0;
var DECELERATION_AMPLITUDE = 0.7;
var DECELERATION_FACTOR = 100;
var TRACKER_TIMEOUT = 200;
...
class ReactTouchHandler {
  ...
  setAutoScrollEndCallback(callback){
      this._onScrollEndCallback = callback;
  }
  ...
  _autoScroll() {
    ...
    if (deltaX !== 0 || deltaY !== 0) {
      ...
      this._onScrollEndCallback&&this._onScrollEndCallback();
    }
  }
}
